...
public class AgilityHeroDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        agilityHero = (AgilityHero) intent.getSerializableExtra(DataContract.AgilityTable.TABLE_NAME);

        configsView();

        tvExpandableOverview.setText(agilityHero.getaHeroOverview());
        tvExpendableDetail.setText(agilityHero.getaHeroDetail());
        tvToolbarTitle.setText(agilityHero.getaHeroName());
        tvRole.setText(agilityHero.getaHeroRole());
